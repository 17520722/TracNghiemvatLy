...
class NoticeExam extends Component {
  ...
  render() {
    var { created_test_info } = this.props;
    return (
      <div className="col-xs-9 col-sm-9 col-md-9 col-lg-9">
        <div className="mr-3">
          <div>
            ...
            <p>
              1. Đề thi trắc nghiệm có 40 câu với 50 phút làm bài. Đọc kỹ đề và
              phân bố thời gian hợp lý cho từng câu hỏi trong đề thi.
            </p>
            <p>
              2. Đề thi có các câu hỏi ở các cấp độ: Nhận biết, thông hiểu, vận
              dụng và vận dụng cao. Nên chọn những câu biết làm trước, tránh sa
              lầy làm mất nhiều thời gian cho một câu hỏi.
            </p>
            <p>
              3. Với mỗi trang đề thi nên xem lại có bỏ sót câu trả lời nào
              không, tránh không chọn câu trả lời để bị mất điểm. Ở bên phải là
              các ô hình tròn được đánh số tương ứng với câu hỏi, thí sinh có
              thể nhấn vào đây để chuyển đến câu hỏi nếu có bỏ sót hay cần sửa
              chữa.
            </p>
          </div>
          <div>
          ...
          <div className="text-right mr-5">
            ...
            <Link to="/home/testing">
              <button className="btn btn-success ml-3">Bắt đầu làm bài</button>
            </Link>
          </div>
        </div>
      </div>
