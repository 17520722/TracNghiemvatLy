...
export const _updateQuestion = (questionId, input) => {
     return {
          query: "mutation {\r\n  updateQuestion(id: \"" + questionId + "\", input: {content: \"" + input.content + "\", level: " + input.level + ", topic: \"" + input.topic +"\", image: \"" + input?.image +"\", setOfAnswer: "+ JSON.stringify(input.setOfAnswer) +"}) {\r\n    code\r\n    content\r\n  }\r\n}",
          variables: {}
     }
}
